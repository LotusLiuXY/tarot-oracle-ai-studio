...
export function OracleCardPreview({ card, featured = false }: { card: OracleCardDraft; featured?: boolean }) {
  ...
  return (
    <article className={`relative grid overflow-hidden rounded-[36px] border border-primary/25 bg-[linear-gradient(160deg,rgba(255,248,239,.98),rgba(238,231,244,.88))] p-5 shadow-[var(--shadow-md)] ${featured ? "min-h-[560px] lg:min-h-[640px]" : "min-h-[390px]"}`} data-el="oracle-card-preview">
